...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (((UIPageControl *)_pageControl).currentPage != indexOnPageControl) {
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(cycleScrollViewWillBeginDragging:)]) {
...
- (void)scrollToTopOrBottom:(NSInteger)index {
